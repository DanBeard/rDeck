...
extern RetHal tDeckProHal;
extern void tDeckBoardInit();
#define BOARD_HAL tDeckProHal
#define BOARD_INIT tDeckBoardInit();
...
// other handles
extern TouchDrvCSTXXX tDeckProTouch; // defined in TDeckProScreen

// pin definitions etc taken from mfr
/**
 * @file      utilities.h
